...
plt.title("Spreading of values in Video Duration")
...
plt.title("distibution of Video Counts")
...
### YOUR CODE HERE ###
plt.figure(figsize=(10,3))
plt.title("Distrubution of the values in Video Counts")
...
### YOUR CODE HERE ###
plt.figure(figsize=(5,2))
plt.title('Box plot of Video Shar Counts')
...
plt.title('Distribution of video download counts')
...
# 
# ==> To analyze the importance of data and their values more deeper 
# 
