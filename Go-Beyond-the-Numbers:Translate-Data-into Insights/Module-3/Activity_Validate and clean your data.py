...
# To understand the value of the company and a trust
...
# 527 row was founded with negative value in Years To Unicorn column
...
# {'Artificial Intelligence', 'Data management and analytics', 'FinTech'} is misspelling in the Industry column 
