...
# 0.13% of the Sales data is missing
...
# **`Sales` are equally distributed between 25 and 350 million**
...
# **TV and Sales have the closer linear relationships between.**
...
# **Is an ideal relationship between TV and Sales**
